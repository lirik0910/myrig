...
class SelectPolicy extends Component {
	...
	componentWillMount() {
		this.setState({ 
			...
			this.policyDataGetRequest(data => this.props.onDataLoaded(data));
		});
	}
	...
	render() {
		...
		return <FormControl className={classes.formControl}>
			...
			<Select
				...
				input={<Input name="policy_id" id={inputID} />}>
...
export default withStyles(styles)(SelectPolicy);