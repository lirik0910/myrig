 ...
 * @extends Component
 */
class SelectNoticeType extends Component {
	...
	componentWillMount() {
		this.setState({ 
			...
			//this.contextDataGetRequest(data => this.props.onDataLoaded(data));
		});
	}
	...
	render() {
		...
		return <FormControl className={classes.formControl}>
			...
			<Select
				...
				input={<Input name="type" id={inputID} />}>
...
export default withStyles(styles)(SelectNoticeType);