...
import EditorFieldItem from './EditorFieldItem/EditorFieldItem.jsx';
 ...
 * @extends Component
 */
class PaperRichtextVariable extends Component {
...
export default connect(mapStateToProps)(withStyles(styles)(PaperRichtextVariable));