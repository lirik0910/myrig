...
<div class="products__container default__container">
	...
	<div class="row row__container product-item__container margin__collapse">
		<div class="col-sm-4 row slider__container margin__collapse" style="padding: 42px 0 0">
			...
			<form action="/checkout_form" method="post">
				<div class="checkout__form">
					...
					<select id="country__select" class="country__select d-none field__grey">
				...
				<div class="payment-types__container">
					...
					<ul class="list__container" style="padding: 12px 24px 0">
						...
						<li class="list__item">
							<input type="radio" class="payment-type__input" name="payment_method" data-id="{{$type->id}}" value="{{$type->id}}" style="display: inline" @if($loop->first) checked='checked' @endif />

							<label class="font-weight-normal">{{$type->title}}</label>
						</li>
						@endforeach
					</ul>
				</div>
		...
		<div class="col-sm-8 product-content__container margin__collapse" style="padding: 42px 0 0 32px">
			<div class="border__container"></div>

			<h3 class="title-default__container font-weight-light" style="margin-top: 10px">
				{{ __('default.your_order') }}
			</h3>

			<div class="checkout-products__container">
				<table class="checkout-products__table">
					<tr>
						...
						<th class="font-weight-light" style="padding: 8px 0">{{ __('default.count') }}</th>
						<th class="font-weight-light" style="padding: 8px 0">{{ __('default.cost') }}</th>
					</tr>
				...
				<div style="border-top: 1px solid #FFF; border-bottom: 1px solid #FFF; padding: 12px 0">
					...
					<div class="d-inline-block checkout-deliveries__container">
						...
						<div class="d-inline-block" style="margin: 0 4px;">
			...
			<button class="default__button text-uppercase confirm__button">{{ __('default.approve_order') }}</button>
		</div>
	</div>
</div>
