...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_FormCheckout__ = __webpack_require__(36);
...
new __WEBPACK_IMPORTED_MODULE_0__Base_js__["a" /* default */]().call(function (e) {
	...
	new __WEBPACK_IMPORTED_MODULE_4__components_FormCheckout__["a" /* default */]();
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Base_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_select2__ = __webpack_require__(37);
...
var FormCheckout = function (_Base) {
	_inherits(FormCheckout, _Base);

	function FormCheckout() {
		_classCallCheck(this, FormCheckout);

		return _possibleConstructorReturn(this, (FormCheckout.__proto__ || Object.getPrototypeOf(FormCheckout)).apply(this, arguments));
	}

	_createClass(FormCheckout, [{
		key: 'initDOMElements',
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._countrySelect.on('change', function (e) {
				return _this2.displayDeliveryMethods($(e.currentTarget));
			});

			this.els._postCheckoutForm.on('submit', function (e) {
				return _this2.submitCheckoutForm(e);
			});
   ...
   */
		...
		value: function submitCheckoutForm(e) {
			e.preventDefault();
   ...
   */
		...
		key: 'displayDeliveryMethods',
		value: function displayDeliveryMethods(currentTarget) {
...
/* harmony default export */ __webpack_exports__["a"] = (FormCheckout);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
