...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_SliderProduct__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_PaperTabs__ = __webpack_require__(31);
...
new __WEBPACK_IMPORTED_MODULE_0__Base_js__["a" /* default */]().call(function (e) {
	...
	new __WEBPACK_IMPORTED_MODULE_4__components_SliderProduct__["a" /* default */]();
	new __WEBPACK_IMPORTED_MODULE_5__components_PaperTabs__["a" /* default */]();
...
var SliderProduct = function (_Base) {
	_inherits(SliderProduct, _Base);

	function SliderProduct(props) {
		_classCallCheck(this, SliderProduct);

		var _this = _possibleConstructorReturn(this, (SliderProduct.__proto__ || Object.getPrototypeOf(SliderProduct)).call(this, props));
  ...
  */
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.initDotsSlider(function (e) {
				return _this2.setFirstSlide(e);
			});
		}
   ...
   */
		...
		value: function initProductSlider() {
			...
			this.els._productSliderContainer.owlCarousel({
				...
				if (!_this3.state.dotClickedFlag) {
					_this3.els._dotsSliderContainer.find('.slide__item.active').removeClass('active');
					$(_this3.els._dotsSliderContainer.find('.slide__item')[index]).addClass('active');

					_this3.els._dotsSliderContainer.trigger('to.owl.carousel', [index, 300, true]);
				}
			});
		}
		...
		value: function initDotsSlider() {
			...
			this.els._dotsSliderContainer.owlCarousel({
				...
				var target = $(e.currentTarget),
				    ...
				    remainder = _this4.els._dotsSlidesCount - index;

				if (_this4.els._dotsSlidesCount - Math.ceil(index / 4) * 4 <= 0) {
					_this4.state.dotClickedFlag = true;
				}

				_this4.els._productSliderContainer.trigger('to.owl.carousel', [target.index(), 300, true]);

				_this4.els._dotsSliderContainer.find('.slide__item.active').removeClass('active');
   ...
   */
		...
		key: 'setFirstSlide',
		value: function setFirstSlide(e) {
			this.els._dotsSliderContainer.find('.owl-item.active').first().children('.slide__item').addClass('active');
		}
	}]);
...
/* harmony default export */ __webpack_exports__["a"] = (SliderProduct);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
var PaperTabs = function (_Base) {
	_inherits(PaperTabs, _Base);

	function PaperTabs() {
		_classCallCheck(this, PaperTabs);

		return _possibleConstructorReturn(this, (PaperTabs.__proto__ || Object.getPrototypeOf(PaperTabs)).apply(this, arguments));
	}

	_createClass(PaperTabs, [{
		key: 'initDOMElements',
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._tabItem.on('click', function (e) {
				return _this2.switchTabs(e);
			});
		}
...
/* harmony default export */ __webpack_exports__["a"] = (PaperTabs);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
