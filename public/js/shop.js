...
var Base = function () {
	...
	_createClass(Base, [{
		...
		key: 'setModuleProps',
		value: function setModuleProps(props) {
...
var SliderRelated = function (_Base) {
   ...
   */
		...
		key: 'redistributeDots',
		value: function redistributeDots(e) {
			$('#related-slider__container .owl-dots').removeClass('disabled');
			$('#related-slider__container .slide-dot__button').each(function (i, el) {
				var target = $(el),
				    id = target.data('id');
