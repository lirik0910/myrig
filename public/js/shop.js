  ...
  */
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._footerContactsItem.on('click', function (e) {
				return _this2.switchContactItems(e);
			});

			/** Open callback dialog
    */
			this.els._connectButton.on('click', function (e) {
				e.preventDefault();
				_this2.props.dialogCallback.open('#contacts__dialog', e);
			});

			/** Open product availability callback form
    */
			this.els._availabilityCartButton.on('click', function (e) {
				e.preventDefault();
				_this2.props.dialogAvailability.open('#availability__dialog', e);
			});

			/** If the product has been cleared to align the footer
    */
			this.baseDOM._footerContainer.on('onFooterAlign', function (e) {
				return _this2.setFooterInBottom();
			});
   ...
   */
		...
		key: 'setFooterInBottom',
		value: function setFooterInBottom() {
   ...
   */
		...
		key: 'switchContactItems',
		value: function switchContactItems(e) {
			var target = $(e.target);
...
var DialogCallback = function (_Base) {
	_inherits(DialogCallback, _Base);

	function DialogCallback(props) {
		_classCallCheck(this, DialogCallback);

		var _this = _possibleConstructorReturn(this, (DialogCallback.__proto__ || Object.getPrototypeOf(DialogCallback)).call(this, props));
  ...
  */
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._selector.on('click', function (e) {
				return _this2.onClose(e);
			});
			this.els._callbackForm.on('submit', function (e) {
			...
			if (this.state.click === false) {
				...
				$.ajax({
					...
					success: function success(e) {
						target.hide();
						button.toggleClass('loading');
						_this3.els._callbackSuccess.show();
						_this3.changeClickState();
					},
...
/* harmony default export */ __webpack_exports__["a"] = (DialogCallback);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
var PaperProduct = function (_Base) {
	_inherits(PaperProduct, _Base);

	function PaperProduct(props) {
		_classCallCheck(this, PaperProduct);

		var _this = _possibleConstructorReturn(this, (PaperProduct.__proto__ || Object.getPrototypeOf(PaperProduct)).call(this, props));
  ...
  */
   ...
   */
		...
		key: 'setTopBorder',
		value: function setTopBorder() {
			var width = this.els._sliderContainer.offset().left,
...
/* harmony default export */ __webpack_exports__["a"] = (PaperProduct);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._deleteButton.on('click', function (e) {
				...
				_this2.baseDOM._footerContainer.trigger('onFooterAlign');
			});
		}
...
var DialogAvailability = function (_Base) {
	_inherits(DialogAvailability, _Base);

	function DialogAvailability(props) {
		_classCallCheck(this, DialogAvailability);

		var _this = _possibleConstructorReturn(this, (DialogAvailability.__proto__ || Object.getPrototypeOf(DialogAvailability)).call(this, props));
  ...
  */
	...
	_createClass(DialogAvailability, [{
		key: 'verifyCallback',
		value: function verifyCallback(r) {
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._addProductButton.on('click', function (e) {
				return _this2.addSelectContainer(e);
			});
			this.els._deleteProductButton.on('click', function (e) {
				return _this2.deleteSelectContainer(e);
			});
			this.els._callbackForm.on('submit', function (e) {
				return _this2.onSubmit(e);
			});
   ...
   */
		...
		value: function onSubmit(e) {
			...
			var captcha = $('#g-recaptcha-response').text(),
			    currentTarget = $(e.currentTarget),
   ...
   */
		...
		key: 'getProductsList',
		value: function getProductsList(id, e) {
			var _this4 = this;
       ...
       */
						...
						/** Render product list
       */
						$('.product-item__container-1 .products__list').append('<li class="list__item" data-id="' + data[i].id + '">' + data[i].title + '</li>');
   ...
   */
		...
		key: 'addSelectContainer',
		value: function addSelectContainer(e) {
			e.preventDefault();

			var count = this.els._productsSelectContainer.children('.product-item__container').length + 1,
   ...
   */
		...
		key: 'deleteSelectContainer',
		value: function deleteSelectContainer(e) {
			e.preventDefault();

			var count = this.els._productsSelectContainer.children('.product-item__container').length;
...
/* harmony default export */ __webpack_exports__["a"] = (DialogAvailability);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_SliderPromo__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_SliderRelated__ = __webpack_require__(27);
...
new __WEBPACK_IMPORTED_MODULE_0__Base_js__["a" /* default */]().call(function (e) {
	...
	new __WEBPACK_IMPORTED_MODULE_4__components_SliderPromo__["a" /* default */]();
	new __WEBPACK_IMPORTED_MODULE_5__components_SliderRelated__["a" /* default */]();
	new __WEBPACK_IMPORTED_MODULE_6__components_ButtonSendToCart__["a" /* default */]();

	var inputProductsCount = new __WEBPACK_IMPORTED_MODULE_11__components_InputProductsCount__["a" /* default */]();
	new __WEBPACK_IMPORTED_MODULE_7__components_Footer__["a" /* default */]({
		dialogCallback: new __WEBPACK_IMPORTED_MODULE_8__components_DialogCallback__["a" /* default */]({ selector: '#contacts__dialog' }),
		dialogAvailability: new __WEBPACK_IMPORTED_MODULE_9__components_DialogAvailability__["a" /* default */]({
			selector: '#availability__dialog',
			toggleList: new __WEBPACK_IMPORTED_MODULE_10__components_ToggleList__["a" /* default */](),
			inputProductsCount: inputProductsCount
		})
	});
});
...
var SliderPromo = function (_Base) {
	_inherits(SliderPromo, _Base);

	function SliderPromo(props) {
		_classCallCheck(this, SliderPromo);

		var _this = _possibleConstructorReturn(this, (SliderPromo.__proto__ || Object.getPrototypeOf(SliderPromo)).call(this, props));
  ...
  */
   ...
   */
		...
		value: function onResized(e) {
			...
			var mobileFlag = this.checkIsMobileRegime();

			if (this.state.preventMobileRegime !== mobileFlag) {
				this.els._singleSliderContainer.trigger('destroy.owl.carousel');

				mobileFlag === true ? this.createSliderForMobile(function (e) {
					return _this2.changePreventMobileRegimeState(mobileFlag);
				}) : this.createSliderForDesctop(function (e) {
					return _this2.changePreventMobileRegimeState(mobileFlag);
				});
			}
		}
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.els._verticalSliderContainer.on('click', '.slide__item', function (e) {
				return _this3.onSlideChange(e);
			});
		}
   ...
   */
		...
		key: 'checkIsMobileRegime',
		value: function checkIsMobileRegime() {
   ...
   */
		...
		key: 'changePreventMobileRegimeState',
		value: function changePreventMobileRegimeState() {
   ...
   */
		...
		key: 'initSingleSlider',
		value: function initSingleSlider() {
			return this.checkIsMobileRegime() === true ? this.createSliderForMobile() : this.createSliderForDesctop();
		}
   ...
   */
		...
		key: 'createSliderForDesctop',
		value: function createSliderForDesctop() {
			var _this4 = this;
			...
			return this.els._singleSliderContainer.owlCarousel({
				...
				return _this4.onSlideChanged(e);
			});
		}
   ...
   */
		...
		key: 'createSliderForMobile',
		value: function createSliderForMobile() {
			var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
   ...
   */
		...
		value: function onSlideChange(e) {
			var currentTarget = this.state.currentSlidePreview = $(e.currentTarget),
			...
			var position = currentSlider.find('.owl-item').eq(currentTarget.index()).position();
...
/* harmony default export */ __webpack_exports__["a"] = (SliderPromo);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
var SliderRelated = function (_Base) {
	_inherits(SliderRelated, _Base);

	function SliderRelated() {
		_classCallCheck(this, SliderRelated);

		return _possibleConstructorReturn(this, (SliderRelated.__proto__ || Object.getPrototypeOf(SliderRelated)).apply(this, arguments));
	}

	_createClass(SliderRelated, [{
		key: 'initDOMElements',
   ...
   */
		...
		value: function createDots() {
			var slidesCount = this.els._relatedSliderContainer.children().length,
			    dotsCount = Math.ceil(slidesCount / 3),
			    i = 0;

			while (i < dotsCount) {
				this.els._relatedDotsContainer.append('<div class="owl-dot owl-dot__container">' + '<button class="slide-dot__button padding__collapse" data-id="' + i + '">' + '<div class="slide-item__progress"></div>' + '</button>' + '</div>');
				i++;
			}
		}
   ...
   */
		...
		key: 'initDotsClick',
		value: function initDotsClick(e) {
			var _this2 = this;

			$('.slide-dot__button').click(function (e) {
				return _this2.changeDot(e);
			});
		}
   ...
   */
		...
		key: 'defineCurrentDots',
		value: function defineCurrentDots(e) {
			var slide = null,
			    owlDots = $('.owl-dot__container');

			owlDots.each(function (i, target) {
	...
	return SliderRelated;
}(__WEBPACK_IMPORTED_MODULE_0__Base_js__["a" /* default */]);

/* harmony default export */ __webpack_exports__["a"] = (SliderRelated);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
