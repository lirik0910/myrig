...
new __WEBPACK_IMPORTED_MODULE_0__Base_js__["a" /* default */]().call(function (e) {
	...
	new __WEBPACK_IMPORTED_MODULE_3__components_SliderIndex__["a" /* default */]({
		background: new __WEBPACK_IMPORTED_MODULE_2__components_Background__["a" /* default */]({ manually: true })
	});
...
var IndexSlider = function (_Base) {
  ...
  */
   ...
   */
		...
		value: function onDOMReady(e) {
			...
			this.initSlider(function (e) {
				_this2.sliderHeightAlign();
				_this2.props.background.getDarkContainerLeftDistance();
				_this2.updateDotsStyles();
			});
		}
   ...
   */
		...
		key: 'updateDotsStyles',
		value: function updateDotsStyles() {
			$('.owl-dots').css({
